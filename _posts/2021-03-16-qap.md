...
{% include figure.html path="assets/img/2021-03-16-qap/qap-2.png" class="img-fluid rounded"  style="max-width: 60%;" %}
...
{% include figure.html path="assets/img/2021-03-16-qap/qap-4.png" class="img-fluid rounded" %}
...
{% include figure.html path="assets/img/2021-03-16-qap/qap-3.png" class="img-fluid rounded" style="max-width: 60%;" %}
